...
const VISUALS = {
  ...
  // SEO loop cycles 2 and 3 (published together 2026-09-21): the training rung
  // and the implementation category noun. Same index group, because both pages
  // are about what to buy and what it costs. Theme continues the strict
  // rotation from ai-consultant-vs-ai-agency (navy): teal, navy. The training
  // page takes the amplifier, whose caption ("AI SCALES WHAT IT FINDS") is the
  // page's own argument that AI amplifies the operational state it is applied
  // to. The implementation page takes dataIntegrityGrid, because its argument
  // is that data preparation is the part of an implementation almost every
  // quote skips.
  "ai-training-for-employees": {
    kicker: "Buying AI Automation · Team Training",
    accentWord: "training",
    motif: "amplifier",
    theme: "teal",
  },
  "ai-implementation-services": {
    kicker: "Buying AI Automation · Implementation",
    accentWord: "implementation",
    motif: "dataIntegrityGrid",
    theme: "navy",
  },
};
...
const PAGES = {
  ...
  // SEO loop cycle 2 (drafted 2026-09-08, ASK-074), approved by Bradley and
  // published 2026-09-21. The page doc 07 assigned to rung 4's search term.
  "ai-training-for-employees": {
    slug: "ai-training-for-employees",
    pageType: "article",
    title: "AI Training for Employees: What Actually Sticks in 2026",
    subhead: "What actually sticks in 2026",
    metaDescription:
      "AI training for employees in 2026: what to teach, what it costs, and why only 36% of workers say their upskilling has been adequate. Prices published.",
    url: "https://modernbizops.com/learn/ai-training-for-employees",
    ogImage:
      "https://modernbizops.com/og/og-learn-ai-training-for-employees.png",
    lastUpdated: "2026-09-21",
    h1: "AI training for employees",
    byline: BYLINE,
    breadcrumb: [
      { name: "Home", url: "https://modernbizops.com" },
      LEARN_CRUMB,
  ...
  // SEO loop cycle 3 (drafted 2026-09-14, ASK-091), approved by Bradley and
  // published 2026-09-21. The ladder's own mechanism noun, written for a
  // company under $50M. The draft's one needs-Bradley flag (the enterprise
  // price band) ships qualitative per the handoff recommendation, with the
  // flag text removed and no enterprise number published.
  "ai-implementation-services": {
    slug: "ai-implementation-services",
    pageType: "article",
    title: "AI Implementation Services for B2B Companies Under $50M",
    subhead: "What the work actually includes, and what it costs at your size",
    metaDescription:
      "What AI implementation services include, what they cost by scope, and why most of the market is priced for enterprises. Written for B2B under $50M.",
    url: "https://modernbizops.com/learn/ai-implementation-services",
    ogImage:
      "https://modernbizops.com/og/og-learn-ai-implementation-services.png",
    lastUpdated: "2026-09-21",
    ...
    faq: [
      {
        ...
        a: "It depends entirely on scope, which is why the honest answer is a price list rather than a range. A paid diagnostic, a cleanup item, a single named system and a monthly seat are four different purchases. Our own numbers are published above. When a provider will not give you theirs, ask them to price one named system rather than the whole engagement, and see whether they can.",
      },
      {
        q: "What are the best AI implementation agencies?",
        a: "The best one for a company your size is probably not on the first list you find, because those lists rank by enterprise revenue. Judge on four things instead: do they price named deliverables, do they ask about your data before they pitch, do they build on tools you already pay for, and will they tell you what not to build.",
      },
      {
        q: "Is AI implementation worth it for a small business?",
        a: "It is worth it when there is one person who will own the result and a process worth automating. It is not worth it when the hope is that AI will replace a function nobody currently runs. Automation gives capacity back to a working process. It does not create one.",
      },
      {
        q: "How long does an AI implementation take?",
        a: "A single named system is usually weeks, not quarters, once the foundation under it is sound. Cleanup items run one to two weeks each. The long part is almost never the build. It is the state of the data and the calendar of the person who has to approve things.",
      },
    ],
    ctaText:
      "If AI has not stuck in your business yet, it is worth knowing why before you buy anything else. The AI Revenue Scan is free, takes about five minutes, and shows you where the gaps are.",
    ctaButtonLabel: "Get the Free Scan",
    ctaUrl: "/scorecard",
  },
};
